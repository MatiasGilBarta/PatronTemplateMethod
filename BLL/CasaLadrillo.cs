...
namespace BLL
{
    public class CasaLadrillo : ConstruccionCasa
    {
        ...
        {
            Console.WriteLine("Construyendo el primer piso de una casa de ladrillos\n");
        }

        protected override void ConstruirTecho()
        {
            Console.WriteLine("Construyendo el techo de una casa de ladrillos\n");
        }

        protected override void RealizarPlanos()
        {
            Console.WriteLine("Realizando los planos de una casa de ladrillos\n");
        }
